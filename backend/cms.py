...
PAGE_SCHEMA: list[dict[str, Any]] = [
    ...
    {
        "id": "flashcards",
        "label": "Ferramenta — Flashcards",
        "lang": "pt",
        "path": "/flashcards.html",
        "fields": [
            {"key": "flashcards_title", "label": "Título", "type": "text"},
            {"key": "flashcards_lead", "label": "Subtítulo", "type": "text"},
        ],
    },
    {
        "id": "flashcards_en",
        "label": "Flashcards (EN)",
        "lang": "en",
        "path": "/en/flashcards.html",
        "fields": [
            {"key": "en_flashcards_title", "label": "Title", "type": "text"},
            {"key": "en_flashcards_lead", "label": "Subtitle", "type": "text"},
        ],
    },
    {
        "id": "youtube_desc",
        "label": "Ferramenta — Descrição YouTube",
        "lang": "pt",
        "path": "/descricao-youtube.html",
        "fields": [
            {"key": "youtube_desc_title", "label": "Título", "type": "text"},
            {"key": "youtube_desc_lead", "label": "Subtítulo", "type": "text"},
        ],
    },
    {
        "id": "youtube_desc_en",
        "label": "YouTube description (EN)",
        "lang": "en",
        "path": "/en/descricao-youtube.html",
        "fields": [
            {"key": "en_youtube_desc_title", "label": "Title", "type": "text"},
            {"key": "en_youtube_desc_lead", "label": "Subtitle", "type": "text"},
        ],
    },
    {
        "id": "podcast_youtube",
        "label": "Ferramenta — Podcast & YouTube",
        "lang": "pt",
        "path": "/podcast-youtube.html",
        "fields": [
            {"key": "podcast_youtube_title", "label": "Título", "type": "text"},
            {"key": "podcast_youtube_lead", "label": "Subtítulo", "type": "text"},
        ],
    },
    {
        "id": "podcast_youtube_en",
        "label": "Podcast & YouTube (EN)",
        "lang": "en",
        "path": "/en/podcast-youtube.html",
        "fields": [
            {"key": "en_podcast_youtube_title", "label": "Title", "type": "text"},
            {"key": "en_podcast_youtube_lead", "label": "Subtitle", "type": "text"},
        ],
    },
    {
        "id": "aula_completa",
        "label": "Ferramenta — Aula completa",
        "lang": "pt",
        "path": "/aula-completa.html",
        "fields": [
            {"key": "aula_completa_title", "label": "Título", "type": "text"},
            {"key": "aula_completa_lead", "label": "Subtítulo", "type": "text"},
        ],
    },
    {
        "id": "aula_completa_en",
        "label": "Full lesson (EN)",
        "lang": "en",
        "path": "/en/aula-completa.html",
        "fields": [
            {"key": "en_aula_completa_title", "label": "Title", "type": "text"},
            {"key": "en_aula_completa_lead", "label": "Subtitle", "type": "text"},
        ],
    },
    {
        "id": "capitulos_es",
        "label": "Capítulos (ES)",
        "lang": "es",
        "path": "/es/capitulos.html",
        "fields": [
            {"key": "es_capitulos_title", "label": "Título", "type": "text"},
            {"key": "es_capitulos_lead", "label": "Subtítulo", "type": "text"},
        ],
    },
    {
        "id": "aulas",
...
def default_nav_config(lang: str) -> dict[str, Any]:
    if lang == "en":
        return {
            ...
            "tools": [
                _nav_link("Summarize PDF / Word", "resumo.html", "resumo", category="Summarize & analyze"),
                _nav_link("URL Summary", "url-resumo.html", "url-resumo", category="Summarize & analyze"),
                _nav_link("Chapters & timestamps", "capitulos.html", "capitulos", category="Summarize & analyze"),
                _nav_link("Podcast & YouTube", "podcast-youtube.html", "podcast-youtube", category="Summarize & analyze"),
                _nav_link("YouTube Description", "descricao-youtube.html", "descricao-youtube", category="Summarize & analyze"),
                _nav_link("AI Questions", "perguntas.html", "perguntas", category="Study & teaching"),
                _nav_link("Lesson Ready", "aula-pronta.html", "aula-pronta", category="Study & teaching"),
                _nav_link("Full lesson", "aula-completa.html", "aula-completa", category="Study & teaching"),
                _nav_link("Flashcards", "flashcards.html", "flashcards", category="Study & teaching"),
                _nav_link("File Converter", "conversor.html", "conversor", category="Convert & edit"),
                _nav_link("Image Converter", "conversor-imagens.html", "conversor-imagens", category="Convert & edit"),
                _nav_link("Text proofreader", "corretor.html", "corretor", category="Convert & edit"),
            ],
            "audience": [
    ...
    return {
        ...
        "tools": [
            _nav_link("Resumo PDF / Word", "resumo.html", "resumo", category="Resumir e analisar"),
            _nav_link("Resumo por URL", "url-resumo.html", "url-resumo", category="Resumir e analisar"),
            _nav_link("Capítulos & timestamps", "capitulos.html", "capitulos", category="Resumir e analisar"),
            _nav_link("Podcast & YouTube", "podcast-youtube.html", "podcast-youtube", category="Resumir e analisar"),
            _nav_link("Descrição YouTube", "descricao-youtube.html", "descricao-youtube", category="Resumir e analisar"),
            _nav_link("Perguntas com IA", "perguntas.html", "perguntas", category="Estudo e ensino"),
            _nav_link("Aula Pronta", "aula-pronta.html", "aula-pronta", category="Estudo e ensino"),
            _nav_link("Aula completa", "aula-completa.html", "aula-completa", category="Estudo e ensino"),
            _nav_link("Flashcards", "flashcards.html", "flashcards", category="Estudo e ensino"),
            _nav_link("Conversor de ficheiros", "conversor.html", "conversor", category="Converter e corrigir"),
            _nav_link("Conversor de imagens", "conversor-imagens.html", "conversor-imagens", category="Converter e corrigir"),
            _nav_link("Corretor de texto", "corretor.html", "corretor", category="Converter e corrigir"),
        ],
        "audience": [
...
DEFAULT_SITE_CONTENT: dict[str, str] = {
    ...
    "flashcards_title": "🃏 Flashcards com IA",
    "flashcards_lead": "Cola uma transcrição ou apontamentos e obtém cartões de estudo (frente/verso) para rever e memorizar.",
    "en_flashcards_title": "🃏 AI Flashcards",
    "en_flashcards_lead": "Paste a transcript or notes and get study cards (front/back) for revision and memorization.",
    "youtube_desc_title": "▶️ Descrição para YouTube",
    "youtube_desc_lead": "Cola a transcrição ou resumo e obtém título, descrição e tags prontos a colar no YouTube.",
    "en_youtube_desc_title": "▶️ YouTube Description",
    "en_youtube_desc_lead": "Paste a transcript or summary and get title, description and tags ready for YouTube.",
    "podcast_youtube_title": "🎙️ Assistente Podcast & YouTube",
    "podcast_youtube_lead": "Da transcrição aos capítulos e à descrição do YouTube — três passos com IA.",
    "en_podcast_youtube_title": "🎙️ Podcast & YouTube Assistant",
    "en_podcast_youtube_lead": "From transcript to chapters and YouTube description — three AI-powered steps.",
    "aula_completa_title": "📚 Assistente Aula completa",
    "aula_completa_lead": "Da transcrição ao resumo, perguntas de revisão e flashcards — quatro passos com IA.",
    "en_aula_completa_title": "📚 Full lesson assistant",
    "en_aula_completa_lead": "From transcript to summary, revision questions and flashcards — four AI-powered steps.",
    "es_capitulos_title": "⏱️ Capítulos y marcas de tiempo",
    "es_capitulos_lead": "Pega una transcripción con marcas de tiempo y obtén capítulos organizados — listos para YouTube o podcasts.",
    "aula_pronta_title": "📦 Aula Pronta",
    "aula_pronta_lead": "Cola a transcrição de uma aula e recebe um pacote completo: resumo para estudar, glossário, ideias-chave e perguntas de revisão com gabarito.",
    "en_aula_pronta_title": "📦 Lesson Ready",
    "en_aula_pronta_lead": "Paste a lesson transcript and get a full study pack: revision summary, glossary, key points and quiz questions with answer key.",
    "es_aula_pronta_title": "📦 Clase lista",
    "es_aula_pronta_lead": "Pega la transcripción de una clase y recibe un pack completo: resumen, glosario, ideas clave y preguntas de repaso con respuestas.",
    "fr_aula_pronta_title": "📦 Cours prêt",
    "fr_aula_pronta_lead": "Collez la transcription d'un cours et recevez un pack complet : résumé, glossaire, points clés et questions de révision avec réponses.",
    "de_aula_pronta_title": "📦 Lektion fertig",
    "de_aula_pronta_lead": "Fügen Sie ein Unterrichtstranskript ein und erhalten Sie ein vollständiges Paket: Zusammenfassung, Glossar, Kernpunkte und Wiederholungsfragen mit Antworten.",
    "es_flashcards_title": "🃏 Flashcards con IA",
    "es_flashcards_lead": "Pega una transcripción o apuntes y obtén tarjetas de estudio (anverso/reverso) para repasar y memorizar.",
    "fr_flashcards_title": "🃏 Flashcards IA",
    "fr_flashcards_lead": "Collez une transcription ou des notes et obtenez des cartes d'étude (recto/verso) pour réviser et mémoriser.",
    "de_flashcards_title": "🃏 Karteikarten mit KI",
    "de_flashcards_lead": "Fügen Sie ein Transkript oder Notizen ein und erhalten Sie Lernkarten (Vorder-/Rückseite) zum Wiederholen.",
    "es_aula_completa_title": "📚 Asistente Clase completa",
    "es_aula_completa_lead": "De la transcripción al resumen, preguntas de repaso y flashcards — cuatro pasos con IA.",
    "fr_aula_completa_title": "📚 Assistant Cours complet",
    "fr_aula_completa_lead": "De la transcription au résumé, questions de révision et flashcards — quatre étapes avec IA.",
    "de_aula_completa_title": "📚 Assistent Volle Lektion",
    "de_aula_completa_lead": "Vom Transkript zur Zusammenfassung, Wiederholungsfragen und Karteikarten — vier KI-Schritte.",
    "es_conversor_imagens_title": "🖼️ Conversor de imágenes",
    "es_conversor_imagens_lead": "Convierte, comprime y redimensiona JPG, PNG, WebP y más — todo en el navegador, privado y gratis.",
    "fr_conversor_imagens_title": "🖼️ Convertisseur d'images",
    "fr_conversor_imagens_lead": "Convertissez, compressez et redimensionnez JPG, PNG, WebP et plus — entièrement dans le navigateur, privé et gratuit.",
    "de_conversor_imagens_title": "🖼️ Bildkonverter",
    "de_conversor_imagens_lead": "Konvertieren, komprimieren und skalieren Sie JPG, PNG, WebP und mehr — vollständig im Browser, privat und kostenlos.",
    "aulas_title": "🎥 Aulas",
    "aulas_body": (
