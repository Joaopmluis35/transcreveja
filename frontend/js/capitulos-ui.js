...
(function (global) {
  ...
  var STRINGS = {
    ...
    es: {
      hint: "Funciona mejor con bloques [MM:SS] — como la transcripción formateada de Ouviescrevi.",
      placeholder: "Pega aquí la transcripción con marcas de tiempo…",
      btn: "⏱️ Generar capítulos",
      loading: "Generando capítulos…",
      needText: "Introduce texto (mín. ~120 caracteres).",
      error: "Error al generar capítulos.",
      truncated: "El texto fue truncado.",
      noTimestamps: "Sin marcas de tiempo — capítulos lógicos (sin horarios).",
      copyYoutube: "Copiar YouTube",
      openYoutubeDesc: "Descripción YouTube",
      copyAll: "Copiar lista",
      copied: "¡Copiado!",
      copyFail: "No se pudo copiar.",
      youtubeHint: "Pega en la descripción de YouTube (un capítulo por línea):",
      chapter: "Capítulo",
    },
    fr: {
      hint: "Idéal avec des blocs [MM:SS] — comme la transcription formatée Ouviescrevi.",
      placeholder: "Collez ici la transcription horodatée…",
      btn: "⏱️ Générer les chapitres",
      loading: "Génération des chapitres…",
      needText: "Saisissez du texte (min. ~120 caractères).",
      error: "Erreur lors de la génération.",
      truncated: "Le texte a été tronqué.",
      noTimestamps: "Pas d'horodatages — chapitres logiques (sans heures).",
      copyYoutube: "Copier YouTube",
      openYoutubeDesc: "Description YouTube",
      copyAll: "Copier la liste",
      copied: "Copié !",
      copyFail: "Impossible de copier.",
      youtubeHint: "Collez dans la description YouTube (un chapitre par ligne) :",
      chapter: "Chapitre",
    },
    de: {
      hint: "Am besten mit [MM:SS]-Blöcken — wie bei Ouviescrevi formatiert.",
      placeholder: "Transkript mit Zeitstempeln hier einfügen…",
      btn: "⏱️ Kapitel generieren",
      loading: "Kapitel werden erstellt…",
      needText: "Text eingeben (min. ~120 Zeichen).",
      error: "Fehler beim Generieren.",
      truncated: "Text wurde gekürzt.",
      noTimestamps: "Keine Zeitstempel — logische Kapitel (ohne Zeiten).",
      copyYoutube: "YouTube kopieren",
      openYoutubeDesc: "YouTube-Beschreibung",
      copyAll: "Liste kopieren",
      copied: "Kopiert!",
      copyFail: "Kopieren fehlgeschlagen.",
      youtubeHint: "In die YouTube-Beschreibung einfügen (ein Kapitel pro Zeile):",
      chapter: "Kapitel",
    },
  };
