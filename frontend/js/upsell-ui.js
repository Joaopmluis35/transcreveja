...
(function (global) {
  ...
  function ensureModal() {
    ...
    el.innerHTML =
      ...
      '    <a href="precos.html" class="oe-upsell-btn oe-upsell-btn--primary" id="oeUpsellCtaPro">Ver plano Pro</a>' +
  ...
  async function fetchBilling() {
    ...
    return billingCache || { enabled: false, price_label: "9,99 €/mês" };
  }

  function showLimit(quota) {
    quota = quota || {};
    ...
    if (tier === "anonymous") {
      show(
        ...
        { hideRegister: false, hidePro: false }
      );
      ...
      show(
        ...
        { hideRegister: true, hidePro: false }
      );
    } else {
